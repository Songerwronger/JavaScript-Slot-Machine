...
while(true) {
    ...
    if (isNaN(numberDepositAmount) || numberDepositAmount <= 0) {
        console.log('Invalid deposit amount, please make sure youre using numbers and not letters or characters.');
    } else {
...
const getNumLines = () => {
    while(true) {
        ...
        if (isNaN(numberoflines) || numberoflines <= 0 || numberoflines > 3) {
            console.log('Invalid number of lines, remember, you can only bet on 1 to 3 lines.');
        } else {
